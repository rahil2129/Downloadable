 ...
 * ID:            %!uniqueid!%
 * Last Modified: 2022-09-07T20:17:24+00:00
 * File:          Model/Export/Data/Order/General.php
...
class General extends \Xtento\OrderExport\Model\Export\Data\AbstractData
{
    ...
    public function getExportData($entityType, $collectionItem)
    {
        ...
        $this->writeValue('store_name', preg_replace('/[^A-Za-z0-9- ]/', ' - ', (string)$order->getStoreName()));

        // Check is Amasty_GiftWrap installed
        if ($this->utilsHelper->isExtensionInstalled('Amasty_GiftWrap')) {
            $saleDataResource = \Magento\Framework\App\ObjectManager::getInstance()->create('Amasty\GiftWrap\Api\SaleData\SaleDataResourceInterface');
            $saleDataResource->loadData(
                'amasty_giftwrap_order',
                'order_id',
                $order
            );
        }
